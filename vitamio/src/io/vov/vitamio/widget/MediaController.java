...
public class MediaController extends FrameLayout {
  ...
  private View.OnClickListener mFfListener = new OnClickListener() {
  ...
  private View.OnClickListener mPreListener = new OnClickListener() {
  ...
  private View.OnClickListener mViedeoQualityListener = new OnClickListener() {
	
	@Override
	public void onClick(View v) {
		mPlayer.videoQuality(mVideoQuality);
	}
};
  
  private View.OnClickListener mLockScreenListener = new OnClickListener() {
		
	@Override
	public void onClick(View v) {
		LinearLayout mediacontroller2_top_linear = (LinearLayout) findViewById(R.id.mediacontroller2_top_linear);
		boolean islocked = (mediacontroller2_top_linear.getVisibility() == View.VISIBLE);
		if(islocked){
			lock();
		}else{
			open();
		}
		mPlayer.lockScreen(islocked);
	}
  };
  ...
  protected View makeControllerView() {
    return ((LayoutInflater) mContext.getSystemService(Context.LAYOUT_INFLATER_SERVICE)).inflate(R.layout.mediacontroller2, this);
  }

  private void initControllerView(View v) {
    mPauseButton = (ImageButton) v.findViewById(R.id.mediacontroller_play_pause2);
    if (mPauseButton != null) {
      mPauseButton.requestFocus();
      mPauseButton.setOnClickListener(mPauseListener);
    }

    mFf = (ImageView) v.findViewById(R.id.mediacontroller_ff);
    if(mFf != null){
    	mFf.requestFocus();
    	mFf.setOnClickListener(mFfListener);
    }
    
    mPrevious = (ImageView) v.findViewById(R.id.mediacontroller_pre);
    if(mPrevious != null){
    	mPrevious.requestFocus();
    	mPrevious.setOnClickListener(mPreListener);
    }
    
    mFullScreen = (ImageView) v.findViewById(R.id.mediacontroller_full_screen);
    if(mFullScreen != null){
    	mFullScreen.requestFocus();
    	mFullScreen.setOnClickListener(mFullScreenListener);
    }
    
    mLockScreen = (ImageView) v.findViewById(R.id.mediacontroller_lock_screen);
    if(mLockScreen != null){
    	mLockScreen.requestFocus();
    	mLockScreen.setOnClickListener(mLockScreenListener);
    }
    
    mVideoQuality = (TextView) v.findViewById(R.id.mediacontroller_video_quality);
    if(mVideoQuality != null){
    	mVideoQuality.requestFocus();
    	mVideoQuality.setOnClickListener(mViedeoQualityListener);
    }
    
    mProgress = (ProgressBar) v.findViewById(R.id.mediacontroller_seekbar2);
    if (mProgress != null) {
    ...
    mEndTime = (TextView) v.findViewById(R.id.mediacontroller_time_total2);
    mCurrentTime = (TextView) v.findViewById(R.id.mediacontroller_time_current2);
...
//      mPauseButton.setImageResource(R.drawable.mediacontroller_pause_button);
    	mPauseButton.setImageResource(R.drawable.mediacontroller2_pause_selector);
    else
//      mPauseButton.setImageResource(R.drawable.mediacontroller_play_button);
      mPauseButton.setImageResource(R.drawable.mediacontroller2_play_selector);
  }
  ...
  private void lock(){
	  ImageView mediacontroller_lock_screen = (ImageView) findViewById(R.id.mediacontroller_lock_screen);
	  mediacontroller_lock_screen.setImageResource(R.drawable.mediacontroller2_lock_selector);
	  LinearLayout mediacontroller2_top_linear = (LinearLayout) findViewById(R.id.mediacontroller2_top_linear);
	  mediacontroller2_top_linear.setVisibility(View.INVISIBLE);
	  RelativeLayout mediacontroller_bottom_rel = (RelativeLayout) findViewById(R.id.mediacontroller_bottom_rel);
	  mediacontroller_bottom_rel.setVisibility(View.INVISIBLE);
  }
  
  private void open(){
	  ImageView mediacontroller_lock_screen = (ImageView) findViewById(R.id.mediacontroller_lock_screen);
	  mediacontroller_lock_screen.setImageResource(R.drawable.mediacontroller2_unlock_selector);
	  LinearLayout mediacontroller2_top_linear = (LinearLayout) findViewById(R.id.mediacontroller2_top_linear);
	  mediacontroller2_top_linear.setVisibility(View.VISIBLE);
	  RelativeLayout mediacontroller_bottom_rel = (RelativeLayout) findViewById(R.id.mediacontroller_bottom_rel);
	  mediacontroller_bottom_rel.setVisibility(View.VISIBLE);
  }
  ...
  public interface MediaPlayerControl {
    ...
    void videoQuality(TextView videoQuality);
    
    void lockScreen(boolean islocked);
