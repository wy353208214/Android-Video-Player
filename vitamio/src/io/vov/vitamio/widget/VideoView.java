...
public class VideoView extends SurfaceView implements MediaController.MediaPlayerControl {
  ...
  private OnMediaControlListener mOnMediaControlListener;
...
//	if(isPlaying())
//		pause();
  	seekTo(getCurrentPosition() + INTERVAL_TIME);
//  	start();
  }
...
//  	start();
  ...
  public void videoQuality(TextView textView){
	  mOnMediaControlListener.videoQuality(textView);
  }
  
  @Override
  public void fullScreen() {
	if(mVideoLayout != VIDEO_LAYOUT_SCALE){
  ...
  public void lockScreen(boolean islocked) {
	  if(mOnMediaControlListener != null)
		  mOnMediaControlListener.lockScreen(islocked);
  }

  public void setOnMediaControlListener(OnMediaControlListener mOnMediaControlListener){
	  if(mOnMediaControlListener != null)
		  this.mOnMediaControlListener = mOnMediaControlListener;
  }
  
  public interface OnMediaControlListener{
	  void lockScreen(boolean islocked);
	  void videoQuality(TextView textView);
  }
}
